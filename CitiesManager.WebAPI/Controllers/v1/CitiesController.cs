...
namespace CitiesManager.WebAPI.Controllers.v1
{
    ...
    public class CitiesController : CustomControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutCity(Guid id, [Bind(nameof(City.CityId))] City city)
        {
            if (id != city.CityId)
            {
                return Problem(detail: "City ID mismatch.", statusCode: 400, title: "City Search");
                //return BadRequest();
            }
